...
loadXMCDAv2(xmcdaDatav2, inDirectory, intensitiesOfPreferencesFile, mandatory = FALSE, xmcdaMessages,"alternativesComparisons")
loadXMCDAv2(xmcdaDatav2, inDirectory, rankRelatedRequirementsFile, mandatory = FALSE, xmcdaMessages,"alternativesValues")
